...
roc_table
```
According to @tbl-roc, the model type that produced the best model is the Boosted Tree because it has the lowest RMSE of 1.43 and a low standard error of 0.0276. The Boosted Tree model's hyperparameter values are `mtry` = 14, `min_n` = 40, `learn_rate` = .631 (see part 1 of Task 9).
